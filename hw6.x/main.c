...
#define READADD 0b01000001
#define WRITEADD 0b01000000
...
unsigned char readPin(unsigned char reg){
    i2c_master_start();
    i2c_master_send(WRITEADD);
    i2c_master_send(reg);
    i2c_master_restart();
    i2c_master_send(READADD);
    unsigned char resp = 0b00000000;
    resp = i2c_master_recv();
    i2c_master_ack(1);
    i2c_master_stop();
    return resp;
}
...
int main() {
    ...
    while (1) {
      ...
      LATAbits.LATA4 = 1;
      response = readPin(0x09);
      if((response & 0b00000001) == 0b00000000){
          writePin(0x0A,0b10000000);
      }
      else{
          writePin(0x0A,0b00000000);
      }
